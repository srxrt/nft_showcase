	...
	return (
      ...
      exchange & earn crypto. Join 25+ million people using ProNef Marketplace"
        ...
        Smooth constant colors of a fluent UI design."
			...
			<SectionWrapper
				title="Deployment"
				description="ProNef is  build using Expo which runs natively on all users'
        ...
        while the second shows the details of a specific NFT"
      ...
      bg-primary flex-col text-center banner04"
			>
				<p className={`${styles.pText} ${styles.whiteText}`}>
					Made with love by <span className="bold">SHOKHRUKH</span>
				</p>
			</div>
		</>
	);
